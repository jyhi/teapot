...
//            response.content_type = teapot_file_read(request.path).content_type;
//            response.content_length = teapot_file_read(request.path).size;
//            response.connection = "close";
//            response.location = NULL;
//            response.allow = NULL;
//            response.content = teapot_file_read(request.path).content;
//            break;
//        case HTTP_HEAD:
//            response.version = HTTP_VERSION;
//            response.status_code = HTTP_STATUS_OK;
...
//            break;
//        case HTTP_POST:
//            teapot_file_write(request.path);
//            response.version = HTTP_VERSION;
...
//            break;
//        case HTTP_DELETE:
//            teapot_file_free(request.path);
//            response.version = HTTP_VERSION;
//            response.status_code = HTTP_STATUS_NO_CONTENT;
//            response.content_type = teapot_file_read("delete.html").content_type;
//            response.content_length = teapot_file_read("delete.html").size;
//            response.connection = "close";
//            response.location = NULL;
//            response.allow = NULL;
//            response.content = teapot_file_read("delete.html").content;
//            break;
//        case HTCPCP_BREW:
//            response.version = HTCPCP_VERSION;
//            response.status_code = TCPCP_STATUS_I_AM_A_TEAPOT;
//            response.content_type = teapot_file_read("teapot.html").content_type;
//            response.content_length = teapot_file_read("teapot.html").size;
//            response.connection = "close";
//            response.location = NULL;
//            response.allow = NULL;
//            response.content = teapot_file_read("teapot.html").content;
//            break;
//        default:
//            break;
//    }
